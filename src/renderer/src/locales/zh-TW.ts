...
export const zhTW: TranslationMap = {
  ...
  "app.importErrorUnsupportedGuidance":
    "請匯入 MusicXML 樂譜或 MIDI；目前檔案是 {ext}。",
  "app.importErrorOversizedTitle": "檔案過大",
  "app.importErrorOversizedGuidance":
    "{fileName} 超過 8 MiB 安全上限，請改選較小的檔案。",
  "app.importErrorParseTitle": "無法解析檔案",
  "app.importErrorParseGuidance":
    "請確認 {fileName} 是有效的 MusicXML 或 MIDI，然後重新匯入。",
  ...
  "app.importActionChooseMidi": "選擇樂譜或 MIDI",
  ...
  "library.importMidi": "匯入樂譜或 MIDI",
  "library.noSongs": "找不到內建歌曲",
  "library.noMatch": "沒有符合篩選的歌曲",
  "library.importHint": "試試匯入樂譜或 MIDI 開始練習",
  "library.addFolder": "加入資料夾",
  "library.importedSongs": "匯入的樂譜與 MIDI",
  "library.watchedFolderCount": "{count} 個監看資料夾",
  "library.importedMissing": "匯入的檔案已遺失。",
  ...
  "library.difficultyDescription.intermediate": "雙手、中速、基礎和弦",
  "library.difficultyDescription.advanced": "複雜節奏、快速樂句、寬廣音域",
  "library.difficultyAria": "難度：{difficulty} — {description}",
  "library.gradeDescription.0": "啟蒙 — 3–5 個音，僅右手（C-E）",
  "library.gradeDescription.1": "入門 — 五指位置，級進（C-G）",
  "library.gradeDescription.2": "初級 — 完整八度，少量跳進",
  "library.gradeDescription.3": "基礎 — 初次雙手，簡單低音",
  "library.gradeDescription.4": "初階 — 雙手，I-V-I 和弦低音",
  "library.gradeDescription.5": "進階初 — 移位、少量臨時記號",
  "library.gradeDescription.6": "中級 — 琶音、阿爾貝蒂低音、2 個臨時記號",
  "library.gradeDescription.7": "中高級 — 寬廣音域、複雜節奏",
  "library.gradeDescription.8": "高級 — 音樂會級技巧",
  "library.category.exercise": "練習曲",
  "library.category.popular": "流行曲",
  "library.category.holiday": "節慶曲",
  "library.category.classical": "古典曲",
  "library.practiced": "已練習",
  "library.bestScoreValue": "最佳：{accuracy}%",
  "library.lessonGroup.firstNotes.title": "初次識譜",
  "library.lessonGroup.firstNotes.description":
    "適合第一次練習的短曲與音符模式。",
  "library.lessonGroup.rightHand.title": "右手旋律",
  "library.lessonGroup.rightHand.description": "以單旋律建立識譜與手型信心。",
  "library.lessonGroup.twoHand.title": "初次雙手合奏",
  "library.lessonGroup.twoHand.description": "不含密集伴奏的簡單雙手協調。",
  "library.lessonGroup.rhythm.title": "節奏與表情",
  "library.lessonGroup.rhythm.description":
    "練習拍號、樂句與不同調性的較長曲目。",
  "library.lessonGroup.classics.title": "中級古典曲",
  "library.lessonGroup.classics.description": "較高等級的古典曲目。",
  ...
  "midi.inputLabel": "輸入",
  "midi.outputLabel": "輸出",
  "midi.inputDevice": "MIDI 輸入裝置",
  "midi.outputDevice": "MIDI 輸出裝置",
  "midi.noneOption": "-- 無 --",
  ...
  "practice.modeLabel": "練習模式",
  "practice.setSpeedTo": "將速度設為 {speed}",
  "practice.playbackSpeedPercentage": "播放速度百分比",
  "practice.loopStartValue": "循環起點：{time}",
  "practice.loopEndValue": "循環終點：{time}",
  "practice.metronomeBeat": "第 {beat} 拍，共 {total} 拍",
  "practice.abLoopRange": "A-B 循環範圍",
  ...
  "settings.themeName.ocean": "海洋",
  "settings.themeName.peach": "蜜桃",
  "settings.themeName.midnight": "午夜",
  ...
  "insights.noDataYet": "尚無資料",
  "insights.accuracyTrendChart": "準確率趨勢圖",
  "insights.sessionAccuracy": "第 {session} 次：{accuracy}%",
  ...
  "celebration.listen.title": "聽完了！",
  "celebration.listen.subtitle": "要再聽一次，還是換一首？",
  "celebration.listen.nextTitle": "下一步試試跟彈",
  "celebration.listen.nextBody": "曲子會停下來等你一起彈。",
  ...
  "celebration.starRating": "獲得 {filled} 顆星，共 {total} 顆",

  // ── Piano Roll Editor ─────────────────────────────────────────
  "editor.open": "開啟鋼琴捲軸編輯器",
  "editor.toolbar": "鋼琴捲軸編輯工具",
  "editor.tool.select": "選取工具",
  "editor.tool.draw": "繪製工具",
  "editor.tool.erase": "擦除工具",
  "editor.toggleQuantize": "切換量化",
  "editor.copySelection": "複製選取項目",
  "editor.pasteNotes": "貼上音符",
  "editor.notes": "音符",
  "editor.noSelection": "未選取音符",
  "editor.selectedCount": "已選取 {count} 個",
  "editor.field.pitch": "音高",
  "editor.field.start": "開始時間",
  "editor.field.duration": "時值",
  "editor.field.velocity": "力度",
  "editor.mixed": "混合值",
  "editor.none": "無",
  "editor.warning.pitchClamped": "音高已限制在 MIDI 範圍 0-127。",
  "editor.warning.startClamped": "開始時間已限制為 0 秒之後。",
  "editor.warning.durationClamped": "時值已限制為至少 0.03125 秒。",
  "editor.warning.velocityClamped": "力度已限制在 MIDI 範圍 1-127。",
  "editor.tracks": "軌道",
  "editor.addTrack": "新增軌道",
  "editor.trackName": "名稱",
  "editor.channel": "頻道",
  "editor.channelAbbrev": "頻道",
  "editor.instrument": "樂器",
  "editor.deleteTrack": "刪除",
  "editor.defaultTrackName": "軌道 {number}",
  "editor.trackTopologyChanged": "軌道結構已變更。",
  "editor.exportMidi": "匯出 MIDI",
  "editor.exported": "已匯出 {fileName}",
  "editor.exportFailed": "MIDI 匯出失敗。",
  "editor.close": "關閉編輯器",
