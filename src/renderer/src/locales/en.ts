...
export const en: TranslationMap = {
  ...
  "library.gradeFilter": "Filter by grade level",
  ...
  "library.gradeDesc.0": "Pre-Starter — 3–5 notes, right hand only (C-E)",
  "library.gradeDesc.1": "Starter — 5-note position, stepwise (C-G)",
  ...
  "library.emptyHint": "Drop a MIDI file here or import one below",
  "library.noMatchTitle": "Hmm, nothing here...",
  "library.noMatchAction": "Try a different search or clear the filter",
  ...
  "practice.timingEarly": "Early",
  "practice.timingLate": "Late",
  ...
  "practice.complete.amazing": "Amazing!",
  "practice.complete.great": "Great job!",
  "practice.complete.good": "Good effort!",
  "practice.complete.tryAgain": "Keep trying!",
  "practice.complete.niceListening": "Nice listening!",
  "practice.playAgain": "Play Again",
  "practice.backToLibrary": "Back to Library",
