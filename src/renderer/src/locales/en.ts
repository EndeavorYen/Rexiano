...
export const en: TranslationMap = {
  ...
  "library.importMidi": "Import a score or MIDI file",
  "library.noSongs": "No built-in songs found",
  "library.noMatch": "No songs match your filter",
  "library.importHint": "Import a score or MIDI file to get started",
  "library.addFolder": "Add folder",
  "library.importedSongs": "Imported scores & MIDI",
  "library.watchedFolderCount": "{count} watched folders",
  "library.importedMissing": "The imported file is missing.",
