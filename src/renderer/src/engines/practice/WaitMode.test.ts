...
function makeTracks(notes: Array<{ midi: number; time: number }>): ParsedTrack[] {
  return [
    {
      name: 'Right Hand',
      instrument: 'Piano',
    ...
    const tracks: ParsedTrack[] = [
      {
        ...
        instrument: 'Piano',
        channel: 0,
        notes: [{ midi: 60, name: 'C4', time: 1.0, duration: 0.5, velocity: 80 }],
      },
      {
        name: 'LH',
        instrument: 'Piano',
        channel: 1,
        notes: [{ midi: 48, name: 'C3', time: 1.0, duration: 0.5, velocity: 80 }],
      },
    ]
