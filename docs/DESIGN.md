...
10. [Phase 7 — 樂譜顯示（已完成）](#10-phase-7--樂譜顯示)
...
- **五線譜顯示**（Phase 7）：Rexiano 結合下落音符與五線譜，支援同步游標與顯示模式切換
...
- Phase 1–9 的 roadmap 實作項目已完成
- v1.0.0 仍需正式 tag / GitHub Release 流程才算實際發佈
