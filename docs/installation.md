...
- **藍牙連接**：需先在作業系統層級完成配對。Windows 若已配對但沒有出現 MIDI 輸入，請安裝 MIDIberry 或 KORG BLE-MIDI Driver 作為橋接，詳見[使用手冊 — 連接 MIDI 鍵盤](./user-guide.md#5-連接-midi-鍵盤)
