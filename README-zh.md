...
藍牙 MIDI 詳細設定請看 [docs/installation.md](docs/installation.md)。
...
歡迎貢獻。建議先閱讀 [docs/architecture-zh.md](docs/architecture-zh.md) 與 [docs/DESIGN.md](docs/DESIGN.md)，再進行較大的功能改動。
